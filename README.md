...
## Consumo de uma API de dados abertos do Banco Central do Brasil

## Site: https://dadosabertos.bcb.gov.br/

#### Função requestAPIBCB:
Parâmetro: 
Data no formato: AAAAT, EX.: 20191

#### Função salvarCSV:
Parâmetros:
DataFrame: Um DataFrame,
nome_arquivo: Caminho e nome do arquivo .CSV, 
separador: Separador dos campos do arquivo .CSV, 

#### Conteúdo das colunas do arquivo .CSV:

| Nome | Tipo | Título | Descrição |
| --- | --- | --- | --- |
| datatrimestre	| Date	| Trimestre	| Data no formato AAAA-MM-DD, EX.: 2024-09-30 |
